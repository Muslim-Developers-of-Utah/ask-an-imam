  ...
  return (
    <div className="max-w-screen-xl items-center justify-between mx-auto p-4">
      <form className="flex items-center">
        ...
        <button
          type="submit"
          className="p-2.5 ml-2 text-sm font-medium text-white bg-green-700 rounded-lg border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300"
        >
          <svg
            className="w-5 h-5 "
            fill="none"
